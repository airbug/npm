...
function pack (targetTarball, folder, pkg, dfc, absoluteSymlinks, cb) {
  ...
  if (dfc) {
    ...
    return lifecycle(pkg, "prepublish", folder, function (er) {
      if (er) return cb(er)
      pack_(targetTarball, folder, pkg, absoluteSymlinks, cb)
    })
  } else {
    pack_(targetTarball, folder, pkg, absoluteSymlinks, cb)
  }
...
function pack_ (targetTarball, folder, pkg, absoluteSymlinks, cb_) {
  function cb (er) {
