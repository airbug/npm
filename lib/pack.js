...
function pack (args, opts, cb) {
  var silent = false;
  var absoluteSymlinks = false;
...
function pack_ (pkg, absoluteSymlinks, cb) {
  cache.add(pkg, null, false, absoluteSymlinks, function (er, data) {
    if (er) return cb(er)
